        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.headerContainer}>
            <Image
              ...
              style={styles.logo}
            />
            <Text style={styles.titleText}>70TH FOUNDING ANNIVERSARY</Text>
          </View>
  
          {/* Agenda */}
          <Text style={styles.sectionTitle}>AGENDA:</Text>
          <Text style={styles.bodyText}>
            TO CELEBRATE LICEO DE CAGAYAN UNIVERSITY'S FOUNDING ANNIVERSARY, WITH
            EXCITING EVENTS AND ACTIVITIES
          </Text>
  
          {/* Venue */}
          <Text style={styles.sectionTitle}>VENUE:</Text>
          <Text style={styles.bodyText}>@LICEO CIVIC CENTER, MAIN CAMPUS</Text>
